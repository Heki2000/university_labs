...
first_time, second_time = int(input(f"Введите время одного занятия по предмету '{first_ob}: ")), int(
    input(f"Введите время одного занятия по предмету '{second_ob}': "))
all_time = int(input("Введите доступное время на неделю: "))
